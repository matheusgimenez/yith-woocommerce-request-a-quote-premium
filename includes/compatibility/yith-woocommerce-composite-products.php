                                ...
                                <tr class="cart_item ywcp_component_child_item" >
                                    ...
                                    <td class="product-name">
                                        ...
                                        if( $child_product->get_sku() != '' && get_option('ywraq_show_sku') == 'yes' ){
                                            $title .= apply_filters( 'ywraq_sku_label', __( ' SKU:', 'yith-woocommerce-request-a-quote' ) ) . $child_product->get_sku();
                                        }
                                    ...
                                    <td class="product-subtotal">
                                        <?php
                                        //wc 2.7
                                        $child_product_price = function_exists( 'wc_get_price_to_display' ) ? wc_get_price_to_display( $child_product ) : $child_product->get_display_price();
                        ...
                        if( isset( $component_data['selection_data'][$wcp_key] ) ) {
                            ...
                            if( $component_data['selection_data'][$wcp_key] > 0 ) {
                                ...
                                <tr>
                                    ...
                                    <td scope="col" style="text-align:left;"><?php echo sprintf( '<strong>%s</strong><br>', $component_item['name'] ); ?><a href="<?php echo  $child_product->get_permalink() ?>"><?php  echo $title ?></a> 
                                    <?php
                                    $item_data = array();
                                    ...
                                    <td scope="col" style="text-align:left;"><?php echo $child_quantity * $composite_quantity ?></td>
